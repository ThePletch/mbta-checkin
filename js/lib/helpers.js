...
(function() {
    ...
    Helpers.mergePredictions = function(predictions) {
      ...
      mergePredictionPair = function(prediction, secondPrediction) {
        return _.extend(prediction, {
          routes: mergePair([prediction, secondPrediction], function(prediction) {
      ...
      mergeRoutePair = function(route, secondRoute) {
        return _.extend(route, {
          directions: mergePair([route, secondRoute], function(route) {
    ...
    Stop.prototype.onClick = function() {
      ...
      return async.map(stopAndChildren, (function(stopId, callback) {
        ...
        return function(err, predictions) {
          ...
          if (!(result.length > 0)) {
            Helpers.events.fire('stop-fetchdata-fail', _this);
  ...
  this.Route = (function() {
    ...
    Route.prototype.setVehicles = function(vehicles) {
      ...
      return Mapper.featureManager.addFeature("live-vehicles", this.vehicles);
    };

    Route.fromRawApi = function(api) {
      var base, name1;
      return (base = Helpers.cache.routes)[name1 = api.route_id] != null ? base[name1] : base[name1] = new Route(api.route_id, api.route_name, "Subway");
    };
