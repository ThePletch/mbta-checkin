...
(function() {
  ...
  this.Ui = (function() {
    ...
    Ui.initialize = function() {
      ...
      Helpers.events.bind('mbta-predictions', function(predictions) {
        return Ui.displayModal('prediction-info', predictions);
      });
      Helpers.events.bind(['mbta-api-sent', 'native-api-sent'], function() {
        return Ui.statusIndicator.setStatus('loading');
      });
      Helpers.events.bind(['mbta-api-completed', 'native-api-completed'], function() {
        return Ui.statusIndicator.setStatus('success');
      });
      Helpers.events.bind(['mbta-api-error', 'native-api-error'], function(error) {
